...
/**
 * Kindly created by Fabiomsr on 20/5/16, changed for this project.
...
public class MoneyTextView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mIntegerSection.textStyle = typedArray.getInt(R.styleable.MoneyTextView_baseTextStyle, 0);
            mSymbolSection.textStyle = typedArray.getInt(R.styleable.MoneyTextView_symbolTextStyle, mIntegerSection.textStyle);
            mDecimalSection.textStyle = typedArray.getInt(R.styleable.MoneyTextView_decimalDigitsTextStyle, mIntegerSection.textStyle);
    ...
    private void drawSection(Canvas canvas, Section section) {
        ...
        mTextPaint.setTypeface(section.getTypeface());
    ...
    private static class Section {
        ...
        private Typeface getTypeface() {
            return textStyle == 0 ? Typeface.DEFAULT : Typeface.DEFAULT_BOLD;
        }
