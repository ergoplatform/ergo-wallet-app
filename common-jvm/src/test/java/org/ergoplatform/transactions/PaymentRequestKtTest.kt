...
class PaymentRequestKtTest {
    ...
    fun parseContentFromQrCode() {
        ...
        val parse1 =
            parsePaymentRequest("https://explorer.ergoplatform.com/payment-request?address=testaddr&amount=1.0&token-tokenId=notNumericAmount")
        ...
        val parse2 =
            parsePaymentRequest("https://explorer.ergoplatform.com/payment-request?address=testaddr&amount=2&token-12345=22.3")
