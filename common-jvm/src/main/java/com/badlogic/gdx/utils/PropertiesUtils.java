...
public final class PropertiesUtils {
	...
	public static void load (HashMap<String, String> properties, Reader reader) throws IOException {
	...
	public static void store (HashMap<String, String> properties, Writer writer, String comment) throws IOException {
		storeImpl(properties, writer, comment, false);
	}

	private static void storeImpl (HashMap<String, String> properties, Writer writer, String comment, boolean escapeUnicode)
		throws IOException {
		if (comment != null) {
